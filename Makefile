...
DEPLOYREPOSITORY=jhamman.github.io

FTP_HOST=localhost
FTP_USER=anonymous
FTP_TARGET_DIR=/

SSH_HOST=dew.hydro.washington.edu
SSH_PORT=22
SSH_USER=jhamman
SSH_TARGET_DIR=/nfs/jet/home/jhamman/public_html/blog
...
deploy: publish
	...
	else cd _build && git clone git@github.com:jhamman/$(DEPLOYREPOSITORY).git; \
	fi
